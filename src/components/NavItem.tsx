              ...
              <div className="grid grid-cols-4 gap-x-8 gap-y-10 py-16">
                <ul className="col-span-4 col-start-1 grid grid-cols-3 gap-x-8">
                  {category.featured.map((item) => (
                    <li key={item.name} className="group relative text-base sm:text-sm">
                      <div className="relative aspect-video overflow-hidden rounded-lg transition-all duration-200 ease bg-gray-100 group-hover:opacity-75">
                        <Image
                          src={item.imageSrc}
